...
<jsp:useBean id="bean" class="com.alkacon.opencms.calendar.CmsSerialDateContentBean" scope="request"><%
	...
	// initialise bean
	org.opencms.file.CmsObject cmsObject=org.opencms.flex.CmsFlexController.getCmsObject(request);
	String detailFile=cmsObject.getSitePath(((org.opencms.jsp.util.CmsJspContentAccessBean) pageContext.getAttribute("content")).getFile());
	bean.init(pageContext, request, response, detailFile);
